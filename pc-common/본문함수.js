...
function news_contents_decorate() {
  ...
  for (var a = 1; a < list.length; a++) {
    ...
    decorated_html += '<div class="' + map.class + '" style="background-color: ' + map.div_color + ";padding: 10px 23px 15px; margin : 0px 0px 28px; font-family: Noto Sans Light;background:" + map.div_background + ';line-height: 30px">';
    decorated_html += '<span class="' + map.class + '" style="font-size: 17px; font-family: Noto Sans Bold;color: ' + map.font_color + ';">' + map.icon_name + "</span>";
